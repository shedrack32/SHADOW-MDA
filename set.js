...
module.exports = { session: process.env.SESSION_ID || 'zokk',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/shedrack32/SHADOW-MDA',
    OWNER_NAME : process.env.OWNER_NAME || "SHADOW-𝐌𝐃",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "255746476002",  
    ...
    CAPTION : process.env.CAPTION || "SHADOW 𝘛𝘌𝘊𝘏",
    BOT : process.env.BOT_NAME || 'SHADOW-𝐌𝐃',
