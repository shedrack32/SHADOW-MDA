...
zokou({ nomCom: "dev", categorie: "General", reaction: "🫶" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "SHADOW 𝘛𝘌𝘊𝘏", numero: "255746476002" },
      { nom: "SHADOW-𝐌𝐃A", numero: "255746476002" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 welcome to SHADOW-𝐌𝐃A! here is the developer :\n\n";
...
zokou({ nomCom: "developer", categorie: "General", reaction: "🦁" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "SHADOW🛰️𝘛𝘌𝘊𝘏", numero: "255746476002" },
      { nom: "SHADOW-𝐌𝐃A", numero: "255746476002" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Welcome to SHADOW-𝐌𝐃A* here is the developer numbers:\n\n";
    for (const dev of devs) {
      message += `----------------\n• ${dev.nom} : https://wa.me/${dev.numero}\n`;
    }
  var lien = mybotpic()
